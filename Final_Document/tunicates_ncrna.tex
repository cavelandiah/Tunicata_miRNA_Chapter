...
\abstract{Tunicates, or urochordates, are a group of small marine organisms
  that are found widely throughout the seas of the world. As most
  ...
  non-coding elements. In this chapter the focus on the ncRNA complement
...
\textit{Oikopleura dioica}, both Ciona species\footnote{In accordance with
  ...
  thompsoni}. These studies have revealed many losses in miRNA families that
...
is incorporated into RISC complex. Sequence complementarity of miR and mRNA
...
\cite{Lee:07a}. \TODO{The rate of gain of miRNA families that retained
...
Until 2008, most of the miRNAs annotations were concentrated in Cionas, 
\TODO{but new annotation approaches for other species in tunicates were 
appearing slowly to increase then the repertory} of new miRNAs families in
...
\textit{H.\ roretzi}. \TODO{For the draft genome sequence} from
...
\TODO{For the preliminary assembled} of the genome sequence for the Southern 
Ocean salp \textit{S.\ thompsoni} \cite{Jue2016} were small RNA libraries
...
\tabularnewline
\caption{Reported clusters in the literature. Bold text represent those miRNAs 
elements that are currently annotated and validated, but could not be detected 
by homology strategies. \textbf{Ciro}: 
\textit{C. robusta}, 
...
csa-mir-92c, csa-mir-92a & NA & miRBase, Homology & \cite{Fu:08} \\
Oidi & scaffold\_1 & $3086369$ & $3086586$ & odi-mir-92b, odi-mir-92a & NA 
& Homology & \cite{Fu:08} \\
\hline
Ciro & 7q & $4969691$ & $4969912$ & cin-mir-124-1, 
cin-mir-124-2 & NA & miRBase, Homology & \cite{Hendrix2010}, \cite{Fu:08} \\
Cisa & reftig\_262 & $49392$ & $49620$ & csa-mir-124-1, 
csa-mir-124-2 & NA & miRBase, Homology & \cite{Fu:08} \\
\hline
...
csa-mir-141 & NA & miRBase, Homology & \cite{Fu:08} \\
