...
\abstract{Tunicates, or urochordates, are a group of small marine organisms
  ...
  non-coding elements. In this chapter the focus lies on the ncRNA complement
...
in \textit{C. robusta} in 2010 by \citet{Keshavan2010} \TODO{which is in the 
...
\cite{Hendrix2010} it is not very common to find related miRNAs organized
...
previously reported under that putative names.  \TODO{They} also found a
...
families. For instance \TODO{the big cluster presumably re-named from
  \cite{Hendrix2010} today} is known to be built by the families miR4000,
...
\ref{tab:otherClusters}). Some other clusters are also found on the
chromosome 1a, 10q and 3p. See this structure in Table
\ref{tab:otherClusters}, most of them were validated by \citet{Hendrix2010}.
...
\citet{Hendrix2010}, which structure is shown in Table
\ref{tab:otherClusters}.
