...
\abstract{Tunicates constitute a representative group of marine organisms that have 
gained great importance at evolutionary biology by their relationship as sister group of vertebrates and their wide use as model organisms at developmental biology research. In overall, genomic analysis have exhibited a fast rate of genomic and evolutionary loss from both, important coding and non-coding RNA elements as well as conserved syntenic regions. This evidence have been collected from the study of \textsl{house-keeping} genes, like Hox genes and non-coding elements as miRNAs. The relationship of the latter ones hinges on the correlation between morphological complexity and the overall observed miRNA repertoire, that have been drastically reduced in tunicates. Regardless of this pattern is possible to identify miRNAs arranged on consecutive locations (as clusters) that have been identified as important regulators on muscle development mechanisms and differential expression during oral siphon regeneration. This control repertoire is not only associated with miRNAs, but also with another ncRNAs as: Yellow Crescent RNA, moRNAs, RMST lncRNAs and Splices-leader RNAs, some of them associated with embryonic development, neurogenesis and mediation of mRNA stability.}
