...
\abstract{Tunicates called also urochordates are a group of small marine 
organisms which have increased great importance for gaining insights into the 
evolution of chordates since are likely considered the sister group of 
vertebrates. These animals are found widely throughout the seas of the world and 
are model organisms to study many aspects of the developmental biology research. 
Current genomic analysis of tunicates indicates that their genomes evolved in a 
fast rate and many evolutionary changes include genome reduction, 
rearrangements and gene loss of some important coding and non-coding RNA 
(ncRNAs) elements or even loss of conserved syntenic genomic regions. This 
evidence have been gained from comparative genomics of the study of 
house-keeping genes, like Hox genes and non-coding elements. In this chapter the 
most importance aspects related to the discovery of ncRNAs in tunicates are 
described and is mainly devoted to describe the families of ncRNAs widely ever 
studied in any animals as well as in tunicates, the microRNAs. Based on the 
genomic information and the well established and widely importance of microRNA 
as key regulators of many gene committed to increase morphological complexity in 
metazoans in this chapter is described the discovery, evolution and the genome 
organization of the miRNA repertoire, that have been drastically reduced in 
tunicates. Functions of ncRNAs as regulators of development in tunicates are 
also reviewed. For instance the function of some miRNAs as key regulators of the 
muscle development or their importance into the regulation of the differential 
expression during the oral siphon regeneration.The functions of other ncRNAs 
like the Yellow Crescent RNA, moRNAs, RMST lncRNAs and Splices-leader RNAs 
associated with the embryonic development, neurogenesis and mediation of mRNA 
stability are finally described.}
...
%alows unregistered users to read the abstract as a teaser for the complete 
...
%capter template \texttt{abstract}) and include them with the source files of 
...
synteny, fast changes in cis-regulatory sequences, and loss of several key 
regulatory developmental genes \cite{Satou2008, Denoeud1381}, such as several 
central or posterior Hox genes involved in AP patterning of metazoans 
\cite{Ikuta:2005} and Gbx involved in the establishment of the 
...
myoplasm, a cytoskeletal domain in oocytes of the ascidian \textit{Styela 
clava} were discovered \cite{Swalla1995}. This yellow crescent or YC RNA 
identified to be present throughout embryonic development was the first example 
involved in envisioning the future of a growing family of ncRNAs that would play 
important roles in growth and development in tunicates \cite{Swalla1995}. This 
asymmetrically distributed ascidian RNAs were part of the set of many other 
RNAs known as maternally synthesized cytoplasmically localized RNAs, discovered 
first in oocytes of Xenopus \cite{Bashirullah1998}.

Though the number of ncRNAs within the tunicates is still unknown an abundant 
and functionally important family of ncRNAs, known microRNAs, is also 
distributed in tunicates as for more of all the animals. Genome 
studies of miRNA prevalence in several species of tunicates (i.e. 
\textit{Oikopleura dioica}, Cionas and \textit{Didemnum vexillum} and 
\textit{Salpa thompsoni}) have revealed many losses of conserved miRNA families 
as well as many gains of unique miRNAs among recently divergent lineages in the 
tunicates when compared to other groups of chordates 
\cite{Fu2008, Velandia-Huerto2016}. Thus, relaxed constraints in the evolution 
of genomes and developmental trajectories in the tunicates may have 
been responsible for the plethora of reproductive strategies, morphologies, and 
life histories observed in the group \cite{Holland2015}.   

Throughout this text, the debatable name of the species \textit{Ciona 
intestinalis} has been replaced by \textit{Ciona robusta} in accordance with 
the ascidian community which adopted the new name based on the ``Morphological 
evidence that the molecularly determined \textit{C. intestinalis} type A and 
type B are different species: \textit{Ciona robusta} and \textit{C. 
intestinalis}" \cite{Brunetti:2015}. 
...
searches using the sequences of cloned small RNA libraries were used to 
annotate 
small RNAs as miRNA candidates. In further steps the recovered  genomic 
flanking 
sequences each side of those mapped candidates were used as input to predicted 
secondary structures by mfold v3.1. This step was used to detect candidates 
that 
...
clones only for $55$ miRNAs was detected expression. As a conclusion the 
authors 
...
\textit{S. thompsoni} and \textit{H. roretzi} blast searches with structural 
alignments where applied on the reported candidates in \cite{Jue2016} and 
\cite{Wang2017}.
