...
\abstract{Los RNAs no codificantes son elementos clave en mecanismos basales y 
de regulacion a nivel celular a largo de diferentes especies de eucariontes y 
procariontes. La intervencion de estos elementos esta ampliamente relacionada 
con procesos a nivel de desarrollo embrionario en donde desde inicios 
de los 90 se conoce su rol en procesos asociados al desarrollo embrionario en 
organismos modelo de gran importancia a nivel experimental y evolutivo como los 
tunicados. Numerosos estudios se han concentrado en el estudio sistematico de 
elementos no codificantes sobre los tunicados, sobretodo en miRNAs, en donde se 
resalta la tendencia a una perdida masiva de familias de miRNAs ampliamente 
conservadas evolutivamente. Adicionalmente, diferentes familias de miRNAs se 
encuentran organizadas en clusters, los cuales mantienen su relacion evolutiva 
debido a una aparente asociacion con procesos del desarrollo de musculo, 
regeneracion de sifones orales en \textit{C. robusta} e incluso en la expresion 
como maternal determinants for early zygotes y expresion de miRNAs asociados al 
sexo en la especie \textit{O. dioica}.}
