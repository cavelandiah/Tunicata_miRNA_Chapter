...
%\includegraphics[scale=1]{./density.pdf} 
...
\begin{figure}[ht]
 ...
 \includegraphics[scale=0.7]{Cluster_images/mir-1_119_33}  \\ 
  \includegraphics[scale=0.7]{Cluster_images/mir-133_113_33} \\
 \includegraphics[scale=0.7]{Cluster_images/mir-183_132_240} \\
 \caption{Multiple alignments of cluster's found along chordate species. Left 
plot summarize the let-7 alignment and its adjacent miRNA families, 
represented by different color schemes (see legend for details), right plot 
corresponds to miR-8 family. \textbf{Bfl}: \textit{B. floridae}, \textbf{Cin}: 
\textit{C. intestinalis},  \textbf{Csa}: \textit{C. savignyi},  \textbf{Dre}: 
\textit{D. rerio} and  \textbf{Lch}: \textit{L. chalumnae}.}
...
/homes/biertank/cristian/Desktop/Tunicata_miRNA_Chapter/Document/matrix.eps}
...
\centering
\includegraphics[]{
/homes/biertank/cristian/Desktop/Tunicata_miRNA_Chapter/Document/Images/finalTre
e.png}
